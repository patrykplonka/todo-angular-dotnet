...
- Create Angular project with ng: `ng new todo-angular-dotnet.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`todo-angular-dotnet.client.esproj`).
